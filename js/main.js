$(function () {
  ...
  $(".hero-section__rateYo").rateYo({
    ...
    onChange: function (rating, rateYoInstance) {
      $(".hero-section__rating-content-js").text(rating);
    },
  });
  // PopUp
  ...
  $(".testimonials__slider").slick({
    ...
    dots: true,
    arrows: false,
    arrowsAppend: $(".testimonials__arrows"),
  });
  ...
  // Реализация аккордеона: при клике на айтем текст скрывается/показывается, минус меняется на плюс
  // $(".faq__accordeon-item").on("click", function () {
  //   $(this).toggleClass('faq__accordeon-item_text_hidden')
  //   $(this).children('p').slideToggle()
  // });
  $(".faq__accordeon-item").on("click", function () {
    if ($(this).hasClass("faq__accordeon-item_text_hidden")) {
      $('.faq__accordeon-item').addClass("faq__accordeon-item_text_hidden");
      $(this).removeClass("faq__accordeon-item_text_hidden");
      $('.faq__item-text').slideUp();
      $(this).children("p").slideDown();
    } else {
      $(this).addClass("faq__accordeon-item_text_hidden");
